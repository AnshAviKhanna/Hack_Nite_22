...
import random
def generate():
    #joke=discord.Embed(title='Joke For You!',color=0xFF34B3)
    #joke.add_field(value=random.choice(joke_data),inline=False)
    j=[
    ...
    joke=discord.Embed(title='Joke For You!',color=0xFF34B3)
    joke.add_field(name="Time for laughter!", value=(random.choice(j)),inline=False)
    return joke

'''import discord
import random
def generate(joke_data):
import requests
import json
url="https://geek-jokes.sameerkumar.website/api?format=json"
print(response.get(url))
#joke_data=(json.loads(requests.get(url).content))
#print(type(joke_data))
    

    joke=discord.Embed(title='Joke For You!',color=0xFF34B3)
    #joke.add_field(name="Time for laughter!", value=(random.choice(joke_data)).replace('\"',"'"),inline=False)
#    return joke
'''